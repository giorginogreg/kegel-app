...
export class CircleComponent {
  ...
  @ViewChild('circleCanvas', { static: true }) canvasRef!: ElementRef<HTMLCanvasElement>;
...
constructor() {}
  ...
  private animate = (duration: number, increase: boolean): void => {
    ...
    const startTime = performance.now();
      ...
      const step = (now: number) => {
        ...
        this.currentRadius = initialRadius + (targetRadius - initialRadius) * progress;
  ...
  decrease() {
    //this.startAnimation(this.durationRef.nativeElement.value, false);
